...
public class BottomNavigationBar implements View.OnClickListener {
    ...
    private LinearLayout mLLBar1, mLLBar2;
    private View mViewBar1, mViewBar2;
    private AppCompatImageView mImageViewBar1, mImageViewBar2;
    private AppCompatTextView mTextViewBar1, mTextViewBar2;
